...
const estadoInicial=()=>{
  ...
  return { 
    arrayPalabra:existeBolsa?arrayPalabra:null,
...
class Ahorcado extends React.Component {
  ...
  render() { 
      ...
      let esGanador=correcta===arraySalida.join("");
      let resultado=<h3>"Felicidades!!"</h3>;
      let tableros=
        ...
        return (
          ...
          <div>
            ...
            <div className={this.props.estilo==="white"?"div_panel_white":"div_panel_dark"}>
              <Panel
...
function Canvas({intentos}){
  return(
    <div className="container_canvas" >
        <canvas id="linea1" width="180" height="210">Su navegador no soporta canvas :( </canvas>
        {Monito(intentos)}
    </div>
  )
}
